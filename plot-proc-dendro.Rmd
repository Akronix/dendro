...
# ts_start<-"2023-01-01 09:00:00" # 2 days after installation
# ts_end<-"2023-12-31 08:00:00" # last timestamp of downloaded data
...
Plot all dendros by class in one graph
...
```{r}
# keep only dendros with valid data:
...
plot_temp_and_humidity <-
  ggplot(data = db.env, aes(x=ts, y=surface.temp)) +
    ggtitle(glue("Temperature and humidity for {PLACE}")) +
...
plot_temp_and_humidity
ggsave(glue('output/{PLACE}-VWCytempAgg.png'), width = 15, height = 10)
```
