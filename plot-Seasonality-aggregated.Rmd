...
ggsave(glue('output/allplaces_aggoneday-seasonalities-byclass-2022.png'), width = 45, height = 30)
```
...
ggsave(glue('output/allplaces_aggoneday-seasonalities-byclass-2023.png'), width = 45, height = 30)
```
